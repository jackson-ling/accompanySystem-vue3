  ...
  <div class="companion-detail-page">
    <div class="scroll-content">
      ...
      <template v-if="companion">
        ...
        <MobileImageViewer v-model:visible="showViewer" :url="companion.avatar" />

        <div class="profile-header">
          <div class="info-card">
            <div class="card-top">
              <div class="left-avatar">
                <el-avatar :size="60" :src="companion.avatar" />
              </div>
...
const comments = ref([
  {
    id: 1,
    username: '张女士',
    userAvatar: 'https://placehold.co/50x50/png?text=U1',
    score: 5,
  ...
  },
  {
    id: 2,
    username: '李先生',
    userAvatar: 'https://placehold.co/50x50/png?text=U2',
    score: 5,
    content: '服务态度很好，很有耐心。',
    date: '2023-10-12',
  },
