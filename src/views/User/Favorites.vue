        ...
        >
          ...
          <div class="card-right">
            ...
            <div class="action-column">
              <div class="heart-action" @click.stop="companionStore.toggleFavorite(item.id)">
...
const favoriteCompanions = computed(() => {
  return companionStore.companionList.filter((c) => companionStore.favorites.includes(c.id))
})

// 页面加载时获取收藏列表和陪诊师列表
onMounted(async () => {
  await Promise.all([
    companionStore.fetchFavorites(),
