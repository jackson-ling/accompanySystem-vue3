...
import type { AvailableOrder, CreateOrderPayload, Order, PaginatedResult, PageParams } from '@/types/api'
...
export function getAvailableOrders(params?: AvailableOrderParams) {
  return request.get<any, AvailableOrder[]>('/companion/available-orders', { params })
}

export function grabOrder(id: string | number) {
  return request.post<any, void>(`/companion/orders/${id}/grab`)
}
